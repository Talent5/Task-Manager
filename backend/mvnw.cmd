...
:mainEnd
rem The variable MAVEN_CMD_LINE_ARGS contains the arguments passed to the wrapper, set it back to global scope
@echo off
rem MAVEN_CMD_LINE_ARGS=%*
...
if not "%OS%"=="Windows_NT" echo 1 >nul && goto mainEnd

rem If we're on Windows and not NT, set errorlevel to 1
